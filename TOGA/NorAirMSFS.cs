...
namespace NorAirMSFS
{
    ...
    public class Connect
    {
        ...
        public static string AppPath = Path.GetFullPath(Application.StartupPath);
        ...
        public List<SimVarEntity> RetrieveSimVarsGroups()
        {
            ...
            try
            {
                filename = AppPath + @"\SIMVARS_AUTOPILOT.txt";
                ...
                {
                    throw new Exception("No data to compile");
                }

                filename = AppPath + @"\SIMVARS_BRAKELANDING.txt";
                if (File.Exists(filename))
                {
                ...
                filename = AppPath + @"\SIMVARS_ELECTRIC.txt";
                if (File.Exists(filename))
                {
                ...
                filename = AppPath + @"\SIMVARS_ENGINE.txt";
                if (File.Exists(filename))
                {
                ...
                filename = AppPath + @"\SIMVARS_FUEL.txt";
                if (File.Exists(filename))
                {
                ...
                filename = AppPath + @"\SIMVARS_RADIOS.txt";
                if (File.Exists(filename))
                {
                ...
                filename = AppPath + @"\SIMVARS_SYSTEMS.txt";
                if (File.Exists(filename))
                {
                ...
                filename = AppPath + @"\SIMVARS_HELI.txt";
                if (File.Exists(filename))
                {
                ...
                filename = AppPath + @"\SIMVARS_OTHERS.txt";
                if (File.Exists(filename))
                {
