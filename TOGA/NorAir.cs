...
namespace NorAir
{
    ...
    public class OBCS
    {
        ...
        /// 
        /// OBCS peripherals default IDs are the first 2 digit of its serial numbers,
        /// from 21 to 98.
        /// ID 99 it is reserved for OBCS itself.
        /// 
        /// J-PORT peripherals default IDs are the first 2 digit its of serial numbers,
        /// from 02 to 09 and from 11 to 20, being 1 and 10 reserved, so not usable.
        /// 
        ...
        public void Flush()
        {
            ...
            {
                // Something went wrong. Debug here
            }
        }
    ...
    public class JPORT
    {
        ...
        public const byte HAT_SWITCH_NORTH = 0;
        public const byte HAT_SWITCH_NORTH_EAST = 1;
        public const byte HAT_SWITCH_EAST = 2;
        public const byte HAT_SWITCH_SOUTH_EAST = 3;
        public const byte HAT_SWITCH_SOUTH = 4;
        public const byte HAT_SWITCH_SOUTH_WEST = 5;
        public const byte HAT_SWITCH_WEST = 6;
        public const byte HAT_SWITCH_NORTH_WEST = 7;
        public const byte HAT_SWITCH_NULL = 8;
        ...
        public const byte SetHatSwitchCmd = 24;
        ...
        public byte[] SetButtonType(byte buttonNumber, byte buttonType)
        {
            ...
            ///         0-Push button
            ///         1-Push button as toggle button
            ///         2-Logically inverted push button
            ///         3-Logically inverted push button as toggle button
            ///         
        ...
        public byte[] SetHatSwitch(byte hatSwitch)
        {
            /// <summary>
            /// Sets the hatswitch direction or none
            /// </summary>
            /// 
    ...
    public class WALL
    {
        ...
        //
        //    CPORT.Send(shout.Backlit(0xFF,0,0,0), SendOnly ); // Just send, don't wait for an answer
        //
    ...
    public class MBx24
    {
        ...
        /// sequential range of joystick button numbers. Using the 'SetFirstButtonNumberCmd',
        ...
        /// 
        /// Also by default, the input tagged in the board by '1' corresponds to button '50',
        ...
        /// button '76', etc.
        /// 
        /// Although a joystick button can be reassigned to a new number, care should be
        ...
        public byte[] SetButtonType(byte buttonNumber, byte buttonType)
        {
            ...
            ///     Button type valid options:
            ///         0-Push button
            ///         1-Push button as a toggle button
            ///         2-Logically inverted push button
            ///         3-Logically inverted push button as a toggle button
            ///         
            ///     Changes can only be made after enumeration. They reset to default after hard-reset.
            ///     
            ///     Despite default buttons 1 and 2 could be reassigned and mapped, they have
