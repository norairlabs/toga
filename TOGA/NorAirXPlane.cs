...
namespace NorAirXPlane
{
    ...
    public class DRefs
    {
        ...
        public List<XPlaneSetup.MBx24Reference> MBx24LoadData(string sn, string prof)
        {
            /// <summary>
            /// Loads the MBx24 profile datarefs to write to X-Plane.
            /// Returns a dictionary of datarefs correspondences or null
            /// </summary>

            List<XPlaneSetup.MBx24Reference> DataRefsToReturn = new List<XPlaneSetup.MBx24Reference>();
            ...
            foreach (XPlaneSetup.MBx24Reference refer in xplanedata.REFERENCES)
            {
                DataRefsToReturn.Add(refer);
            }
