...
namespace TOGA
{
    public partial class XPlaneSetup : Form
    {
        ...
        public static string AppPath = Path.GetFullPath(System.Windows.Forms.Application.StartupPath);
        ...
        public List<string> ReadDataRefs()
        {
            ...
            if (File.Exists(Path.GetFullPath(AppPath) + @"\DataRefs.txt"))
            {
                if (!File.Exists(XPlanePath + @"\DataRefs.txt"))
                {
                    File.Copy(Path.GetFullPath(AppPath) + @"\DataRefs.txt", XPlanePath + @"\DataRefs.txt");
                }
            }
            ...
            copyLabel.Text = "Copy this dataref, please";
        ...
        private void PasteDataRef(object sender, EventArgs e)
        {
        ...
        public void DrawXPlaneRNS()
        {
            ...
            ContextMenuStrip docMenu = new ContextMenuStrip(); // Instantiate
            docMenu.Click += new EventHandler(PasteDataRef);     // Event handler
            ToolStripMenuItem copyLabel = new ToolStripMenuItem();  // Create a label "Copy"
            copyLabel.Text = "Paste the dataref here, please";
            docMenu.Items.AddRange(new ToolStripMenuItem[] { copyLabel }); // Fill the menu
            ...
            Label DRtoRead = new Label()
            {
                ...
                Visible = false     // Disabled to users. May conflit with datarefs writing
            };
        ...
        private void SetNumericUpDownField(string FieldName, decimal FieldValue)
        {
            /// <summary>
            /// Sets the text of a textbox 'FieldName' with the 'FieldValue'
            /// </summary>
            ...
            if (fields.Length != 0)
            {
                ...
                v.SetValue(fields[0], FieldValue);
            }
        }
        ...
        {
            /// <summary>
            /// Method to paint the XPlane MBx24 definitions panel
            /// </summary>
            /// 
        ...
        public void MBx24FillData(string serial, int id)
        {
            ...
            foreach (MBx24Reference r in mbx24Sets.REFERENCES)
            {
                ...
                SetNumericUpDownField("MBX24DRVALUE" + con, r.ONVALUE);
            }
        }
        ...
        public void SaveMBx24Data()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                r.ONVALUE = (decimal)MBX24DRVALUE[i].Value;
