...
namespace TOGA
{
    public partial class MSFSSetup : Form
    {
        ...
        private bool MSFSRNSFillSimVarsList()
        {
            ...
            if (!RNSCreateSimVarsList())
            {
                return false;
            }

            if (!RNSCreateEventIDsList())
            {
                return false;
            }
            ...
            if (lines == null || lines.Length < 32)
            {
                Say("A SimVar files is missing");
                return false;
            }
        ...
        private void PasteSimVar(object sender, EventArgs e)
        {
            ...
            {
                sourceControl.Text = Clipboard.GetText();
            }
        }

        private bool RNSCreateSimVarsList()
        {
            ...
            if (MSFSsimvars==null || MSFSsimvars.Count == 0)
            {
                return false;
            }
        ...
        private bool RNSCreateEventIDsList()
        {
        ...
        public bool DrawMSFSRNS()
        {
            ...
            TextBox COMMACTTOREAD = new TextBox()
            {
                ...
                ReadOnly = false,
                Font = new Font("Microsoft Sans Serif", 10),
                Visible = false //      Uncomment to use. ( NOT RECOMMENDED )
            };
        ...
        private bool DrawMSFSMBx24()
        {
            /// <summary>
            /// Method to paint the MSFS MBx24 definitions panel
            /// </summary>
            /// 
            ...
            docMenu.Click += new EventHandler(PasteSimVar);     // Event handler
            ToolStripMenuItem copyLabel = new ToolStripMenuItem();  // Create a label "Copy"
            copyLabel.Text = "Paste the SimVar here, please";
            ...
            for (int i = 0; i != 32; i++)
            {
                ...
                txtbox.ContextMenuStrip = docMenu;
                SVTOREAD[i] = txtbox;
            ...
            if (!MSFSMBx24FillSimVarsTreeView())
            {
                return false; ;
            }
        ...
        public bool MBx24CreateSimVarsList()
        {
            ...
            if (MSFSsimvars == null || MSFSsimvars.Count()==0)
            {
                Say("It was not possible to compile SimVars.\n A file is missing.");
                return false;
            }
        ...
        public bool MSFSMBx24FillSimVarsTreeView()
        {
            /// <summary>
            ...
            if (lines == null || lines.Length < 32)
            {
                Say("There was an error reading SimVars file.");
                return false;
            }
